  ...
  module Handlers
    class Sales
      ...
      def bulk_find_or_create
        ...
        loop do
          data_orders = Baqio::Data::Orders.new(@page +=1, @user_id, @min_date, @max_date).result.compact
      ...
      private
        ...
        def create_sale_items(sale, order)
          sale_items = Baqio::Handlers::SaleItems.new(vendor: @vendor, sale: sale, order: order)
        ...
        def create_update_or_delete_incoming_payments(sale, order)
          incoming_payments = Baqio::Handlers::IncomingPayments.new(vendor: @vendor, sale: sale, order: order)
        ...
        def find_or_create_entity(vendor, order_customer)
          ...
          entity = Baqio::Handlers::Entities.new(vendor: vendor, order_customer: order_customer)

    ...
    module Handlers
      class ProductNatureVariants
        ...
        def find_or_create_variant(order_line_not_deleted)
          product_nature_variant = ProductNatureVariant.of_provider_vendor(@vendor).of_provider_data(:id, order_line_not_deleted[:product_variant_id].to_s).first
          ...
          if product_nature_variant.present?
            ...
            product_nature_variant =  ProductNatureVariant.create!(
              ...
              unit_name: "Unité",
              provider: { vendor: @vendor, name: "Baqio_order_line_not_deleted", data: {id: order_line_not_deleted[:product_variant_id].to_s} }      )
          end
        end

  ...
  module Handlers
    class SaleItems
      ...
      def find_or_create_baqio_country_tax(tax_line)
        ...
        country_tax_baqio = Baqio::Data::CountryTaxes.new(country_tax_id: country_tax_id).result.first
      ...
      def find_or_create_variant(order_line_not_deleted)
        variant = Baqio::Handlers::ProductNatureVariants.new(vendor: @vendor,
